...
<body>
	...
	<hr>
	<form method="post" action=".\Register?action=insertSeller">
        <fieldset>
            <legend>賣家資料一<span id="must">*<em>(必填)</em></span></legend>
            ...
            <div class="st1">
                ...
                <input type="date" id="datefield" name="dob" min="1900-01-01" max="2050-12-31" maxlength="10">
            </div>
            <div class="st1">
            ...
            <div class="st1">
                <label for="extensionNumber1" class="t1">分機號碼：</label><input type="text" id="extensionNumber1"
                    name="extensionNumber" placeholder="#1234" maxlength="5" autocomplete="off" size=10>
            </div>
            <div class="st1">
        ...
        <fieldset>
            <legend>賣家資料上傳</legend>
            <div class="st1">
                <label for="" class="t1"><span id="must">*</span>營業登記證明：</label>
